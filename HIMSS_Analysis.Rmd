...
# loading CMS Narcotics data
Narcs <- read.csv("data/op_2021_data.csv")
```
...
### 2. Our second collection of data comes from the Center for Medicare and Medicaid Services (CMS), and can be accessed here (https://data.cms.gov/Medicare-Part-D/Medicare-Part-D-Opioid-Prescriber-Summary-File-201/j2ra-95gh). This data was last updated Feb 2021 and additional information can be provided by emailing MedicareProviderData@cms.hhs.gov . This dataset contains the following relavent columns:

E. *Narcs*: 

    - Description: This table contains the prescriber information for all opioid containing prescriptions tracked in the DEA database.
    
    - Link: This table links to HIMSS's table 'HA_NPI' by *NPI* (National Provider Identifier) information. 
